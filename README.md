...
This project is actively running on a **Dell R420 (`automation`, 192.168.1.100)** monitoring an EG4 6000XP inverter (serial `5xxxxxxxx`) via the WiFi dongle at `192.168.1.100:8000`.
